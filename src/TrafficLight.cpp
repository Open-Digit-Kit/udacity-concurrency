...
template <class T>
bool MessageQueue<T>::QueueNotEmptyCheck()
{
    return !_queue.empty();
}
...
T MessageQueue<T>::receive()
{
	...
	_condition.wait(lock, std::bind(&MessageQueue<T>::QueueNotEmptyCheck, this));
  	T msg = std::move(_queue.front()); _queue.pop_front();
  	return msg;
}
